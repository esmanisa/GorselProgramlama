...
#include <memory>
#include "../../GPD-11-TCPServer/server.h"
...
QT_MOC_LITERAL(4, 29, 11) // "readyToRead"

    },
    "Server\0changed\0\0disConnected\0readyToRead"
};
...
void Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Server::changed)) {
                *result = 0;
                return;
            }
        }
